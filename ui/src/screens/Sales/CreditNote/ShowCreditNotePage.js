...
import { api_add_credit, api_add_debit } from "../../../utils/PageApi";
import {
...
export default function ShowCreditNotePage() {
  ...
  const handleDbUpdate = async () => {
    const res = await ipcRenderer.invoke("update-credit-note", formValues);
  };
